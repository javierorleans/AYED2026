...
public class MainTp2Ej5 {
	...
	public static void main(String[] args) {
		 ...
		 */
		  ...
		  ProfundidadDeArbolBinario base = new ProfundidadDeArbolBinario();
		  
		  base.setArbol(l0);
		  
		  int nivel = 2;
		  
		  int suma = base.sumaElementosProfundidad(nivel);		  
		  
		  System.out.println("La suma de los elementos del nivel " + nivel + " es " + suma);
